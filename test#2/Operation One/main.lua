...
if (not (game:IsLoaded() and getgenv().drawingLoaded)) then repeat task.wait() until (game:IsLoaded() and getgenv().drawingLoaded) end do
    ...
    do -- includes
        ...
        for _, file in next, (inculdes) do
            for i, v in next, (loadstring(game:HttpGet("https://github.com/suannelson123/op-modules/tree/26e28d8d06e60538318639393e084c5d9ea1600b/test%232/Operation%20One" .. file, true))()) do
                if (i == "init") then
